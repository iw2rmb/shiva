...
Documentation: `design/inc.md`, `design/init.md`, `design/mono.md`, `docs/gitlab.md`, `docs/database.md`, `docs/testing.md`, `internal/openapi/resolver.go`, `cmd/shiva/main.go`, `internal/store`, `sql/schema/000001_initial.sql`
...
- [x] Confirm current implementation does not satisfy `design/inc.md` expectations — establishes exact incremental gaps before coding
  - Repository: `shiva`
  - Component: `cmd/shiva`, `internal/openapi`, `internal/store`, `docs`
